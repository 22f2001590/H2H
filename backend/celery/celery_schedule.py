...
def setup_periodic_tasks(sender, **kwargs):
    ...
    sender.add_periodic_task(crontab(hour=21, minute=0), email_reminder.s('Reminder to Login', '<h1>Hello User, How can we help you tomorrow?</h1>'), name='daily reminder')
    ...
    # sender.add_periodic_task(crontab(hour=20, minute=24), email_monthly_report.s(), name='monthly reminder')
