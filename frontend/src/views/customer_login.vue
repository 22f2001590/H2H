        ...
        <div class="container text-center mt-5">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4 mt-4">
                ...
                <div class="col d-flex flex-column justify-content-center align-items-center">
                    <h4><strong>Customer Login</strong></h4>
                    ...
                    <div class="mt-3">
                        Don't have a customer account? <router-link to="/customer_signup">Sign up</router-link>
                    </div>
                </div>
            </div>
        </div>
        ...
        async handleLogin() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    this.$router.push('/customer_dashboard'); // Redirect to the dashboard
                } else {
