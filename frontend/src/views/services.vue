                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <!-- <strong>Service Professionals:</strong>
                      <ul>
                        <li v-for="user in service.users" :key="user.id">
                          <router-link :to="`/professional_history/${user.id}`">{{ user.name }}</router-link> | Rating:
                          {{ avgRating(user.service_request_as_professional) }}
                        </li>
                      </ul> -->
                    </div>
                  </div>
...
export default {
  ...
  setup() {
    ...
    //   return serviceRequests.length ? serviceRequests.length : "No rating";
    // };
