          ...
          <ul class="list-group">
            <li v-for="professional in professionals" :key="professional.id"
              ...
              <div>
                ...
                <br />
                <!-- <small>
                    <b>{{ professional.service?.name || 'No Service' }}</b>, Rating: {{ avgRating(professional.service_request_as_professional) }}
                  </small>
                  <br /> -->
...
export default {
  ...
  setup() {
    ...
    //   // Calculate average rating, replace with actual rating logic
    //   return serviceRequests.length ? 4.5 : 'No Rating';
    // };
