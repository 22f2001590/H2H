                    ...
                    <div class="row align-items-center">
                      <div class="col-md-8">
                        ...
                        <p class="mb-0">
                          ...
                          <!-- <strong>Time:</strong> {{ formatTime(rs.needed_at) }} -->
                        </p>
                      </div>
                    ...
                    <div class="row mt-3">
                      <div class="col-12 text-center">
                        ...
                        <div v-else-if="as.status === 'paid'">
                          <!-- <button class="btn btn-success px-4 py-2" data-bs-toggle="modal" :data-bs-target="`#closeModal-${index}`">
                  Close
                </button> -->
...
export default {
  ...
  methods: {
    ...
    //   });
    // },
    // closeRequest(serviceId, index) {
    //   const feedback = this.feedbackMessages[index];
    //   console.log(`Closing request ${serviceId} with feedback: ${feedback}`);
    //   alert(`Request ${serviceId} closed successfully!`);
    // },
  },
};
</script>
